...
*/
    ...
    {
        int result = Duration.sixtyFourth;
        /*Unpack stroke value.
        ...
        {
            case 1: 
                result = Duration.hundredTwentyEigth; 
                break;
            case 2: 
                result = Duration.sixtyFourth; 
                break;
            case 3: 
                result = Duration.thirtySecond; 
                break;
            case 4: 
                result = Duration.sixteenth; 
                break;
            case 5: 
                result = Duration.eigth; 
                break;
            case 6: 
