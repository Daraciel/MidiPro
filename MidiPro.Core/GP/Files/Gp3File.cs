...
namespace MidiPro.Core.GP.Files
{
    ...
    */
        ...
        private List<SlideTypes> ReadSlides()
        {
            ...
            retVal.Add(SlideTypes.ShiftSlideTo);
            return retVal;
        }
        ...
        {
            return UnpackVelocity((sbyte)dyn);
        }
        ...
        {
            int result = (int)Durations.SixtyFourth;
            /*Unpack stroke value.
        ...
        private void ReadNewChord(Chord chord)
        {
            ...
            chord.Type = (ChordTypes)GpBase.ReadInt()[0];
            chord.Extension = (ChordExtensions)GpBase.ReadInt()[0];
            ...
            chord.Fifth = (ChordAlterations)GpBase.ReadInt()[0];
            chord.Ninth = (ChordAlterations)GpBase.ReadInt()[0];
            chord.Eleventh = (ChordAlterations)GpBase.ReadInt()[0];
            chord.FirstFret = GpBase.ReadInt()[0];
            for (int i = 0; i < 6; i++)
            {
                var fret = GpBase.ReadInt()[0];
            ...
            chord.Barres.Clear();
            int barresCount = GpBase.ReadInt()[0];
